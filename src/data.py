...
def get_data_loaders(
    ...
    base_path: Path = Path(get_data_location())
    ...
    train=transforms.Compose(
        [
            ...
            transforms.RandomCrop((224, 224), padding_mode='reflect', pad_if_needed = True),
            transforms.RandomHorizontalFlip(0.5),
            transforms.RandomGrayscale(0.3),
            transforms.GaussianBlur((5, 9), (0.1, .2)),
    ...
    valid=transforms.Compose(
        [
            transforms.Resize((256, 256)),  # Resize images to (256, 256)
            transforms.CenterCrop((224, 224)),  # Crop images to (224, 224)
            transforms.ToTensor(),
            transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5)),
        ]
    ),
